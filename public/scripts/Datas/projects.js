export const projects = [
  {
    ...
    projectFeatures: [
      ...
      },
      {
        ...
        Headline: 'Feature Two Headline',
        Info: 'Information about Feature Two.',
        ImageLink: '/assets/projects/features/SuperKrishak/featureOne.jpg'
      }
    ]
  },
  {
    ...
    projectOverview:{
      Headline:'Overview',
      Challenge:'UpKite recognizes the array of challenges newcomers face in a new city—navigating unfamiliar streets, finding essential services, understanding local transport, establishing social connections, and accessing crucial information. It aims to simplify this journey, offering comprehensive support to empower individuals in their transition.',
      Approach:'UpKite employs personalized recommendations, fosters community connections, and centralizes essential information to ease newcomers transition into a new city.',
    },
    
    projectVision:{
      Headline:'Easy Accquantaince',
